...
class wp_bootstrap_navwalker extends Walker_Nav_Menu {
    ...
    public static function fallback( $args ) {
        //if ( current_user_can( 'manage_options' ) ) {
            ...
            $fb_output .= '>';
            $fb_output .= '<li class="nav-item"><a href="#" class="nav-link text-dark">Home</a></li>';
            $fb_output .= '<li class="nav-item"><a href="#" class="nav-link text-dark">About Us</a></li>';
            $fb_output .= '<li class="nav-item"><a href="#" class="nav-link text-dark">Gallery</a></li>';
            $fb_output .= '<li class="nav-item"><a href="#" class="nav-link text-dark">Contact Us</a></li>';
